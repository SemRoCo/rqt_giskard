...
from rqt_giskard_lib.behaviour_tree import RosBehaviourTree
...
if RosBehaviourTree.no_roscore_switch in sys.argv:
    ...
    main = Main()
    sys.exit(main.main(sys.argv, standalone='rqt_giskard_lib.behaviour_tree.RosBehaviourTree', plugin_argument_provider=RosBehaviourTree.add_arguments))
