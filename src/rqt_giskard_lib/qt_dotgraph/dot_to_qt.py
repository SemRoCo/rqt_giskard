...
import pygraphviz
import pyparsing
from qt_dotgraph.edge_item import EdgeItem
...
class DotToQtGenerator():
    ...
    def addEdgeItem(self,
                    ...
                    nodes: Dict[str, pygraphviz.Node],
                    edges: Dict[str, List[EdgeItem]],
                    highlight_level: int,
                    same_label_siblings: bool = False):
        """
        ...
        edge_item = EdgeItem(highlight_level=highlight_level,
                             ...
                             penwidth=1,  # todo set this somewhere?
                             edge_color=color,
                             style=style)
    ...
    def dotcode_to_qt_items(self, dotcode: str, highlight_level: int, same_label_siblings: bool = False) \
            -> Tuple[Dict[str, pygraphviz.Node], Dict[str, List[EdgeItem]]]:
        """
